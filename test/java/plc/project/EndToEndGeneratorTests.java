...
public class EndToEndGeneratorTests {
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource
    void ownFunction(String test, String input, String expected) {

        test(input, expected, Parser::parseFunction);
    }

    private static Stream<Arguments> ownFunction() {
        return Stream.of(
                Arguments.of("Multiple Statements Function",
                        ...
                        String.join(System.lineSeparator(),
                                "public class Func {",
                                "    public static void func(Integer x, BigDecimal y, String z) {",
